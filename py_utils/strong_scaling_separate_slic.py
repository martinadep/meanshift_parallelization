...
ax.set_title('Execution Time Comparison between Implementations', fontsize=18)
ax.set_xticks(index)
...
# Configura gli assi e le etichette
ax_speedup.set_xlabel('Num of Threads', fontsize=16)
ax_speedup.set_ylabel('Speedup', fontsize=16)
ax_speedup.set_title('Speedup comparison between implementations', fontsize=18)
ax_speedup.set_xticks(index)
ax_speedup.set_xticklabels([str(t) for t in threads], fontsize=14)
ax_speedup.legend(fontsize=12)
plt.grid(axis='y', linestyle='--', alpha=0.7)
ax_speedup.tick_params(axis='y', labelsize=14)
